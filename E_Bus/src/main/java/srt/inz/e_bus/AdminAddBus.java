...
public class AdminAddBus extends Activity{
	...
	EditText  etbn,etbf,etstim,etetim; Spinner spsrc,spdest,spbtyp; Button mbadd;
	
	ArrayAdapter<String> sarray_bussrc,sarray_busdest,sarray_bustype; String sbssrc,sbdest,sbstype,resplist,respdb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spbtyp=(Spinner)findViewById(R.id.mspinnaddbtype);
		...
		String[] btyp = getResources().getStringArray(R.array.bustype);
		sarray_bustype=new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,btyp);
		sarray_bustype.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spbtyp.setAdapter(sarray_bustype);
		spbtyp.setOnItemSelectedListener(new OnItemSelectedListener()
        {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				// TODO Auto-generated method stub
				sbstype=arg0.getItemAtPosition(arg2).toString();
				
				((TextView) arg0.getChildAt(0)).setTextColor(Color.BLUE);
				
			//	Toast.makeText(getApplicationContext(), ""+sbstype, Toast.LENGTH_SHORT).show();
		...
		protected String doInBackground(String... params) {
			...
			try {
				urlParameters= "busno="+ URLEncoder.encode(sbn, "UTF-8") +"&&"
						...
						+"bus_type="+ URLEncoder.encode(sbstype, "UTF-8") +"&&"
