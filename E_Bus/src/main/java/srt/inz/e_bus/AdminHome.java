...
public class AdminHome extends Activity{
	...
	Button btaddbus,btaddloc,btaddnotif,btaddbusstop,btapproval,btvacards;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btvacards=(Button)findViewById(R.id.mbt_vacards);
		
		btvacards.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i=new Intent(getApplicationContext(),AdminApproveCards.class);
				startActivity(i);
			}
		});
